...
document.addEventListener("DOMContentLoaded", () => {
  const images = [
    "imgs/Section_1/background.f8e0a3e86fb4252623af.png",
    "imgs/Section_1/background.png",
    "imgs/Section_1/mountains.png",
    "imgs/Section_1/logo_land.png",
    "imgs/Section_1/jungle1.png",
    "imgs/Section_1/jungle2.png",
    "imgs/Section_1/jungle3.png",
    "imgs/Section_1/jungle4.png",

    
    "imgs/Section_8/background.f8e0a3e86fb4252623af.png",
    "imgs/Section_8/background.png",
    "imgs/Section_8/mountains.png",
    "imgs/Section_8/logo_land.png",
    "imgs/Section_8/jungle1.png",
    "imgs/Section_8/jungle2.png",
    "imgs/Section_8/jungle3.png",
    "imgs/Section_8/jungle4.png",

    "imgs/Section_11/background.f8e0a3e86fb4252623af.png",
    "imgs/Section_11/background.png",
    "imgs/Section_11/mountains.png",
    "imgs/Section_11/logo_land.png",
    "imgs/Section_11/jungle1.png",
    "imgs/Section_11/jungle2.png",
    "imgs/Section_11/jungle3.png",
    "imgs/Section_11/jungle4.png",

    "imgs/Section_6/1.png",
    "imgs/Section_6/2.png",
    "imgs/Section_6/3.png",
    "imgs/Section_6/4.png",
  ];
